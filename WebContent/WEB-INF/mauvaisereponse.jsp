...
<div class="bg-dark">
    ...
    <div class="container">
        ...
        <form action="mauvaisereponse" method="get">
        
        <div class="row m-3">
            <div class="col-12 col-lg-12">
                <div class="card" style="background-color: red;box-shadow: 5px 5px 5px gray;">
                	<div style="display:flex;">
	                    <img src="img/orange.png" alt="orange" class="card-img-top" style="width:20%;">
	                    <p class="card-text" style="border:4mm ridge rgba(0, 177, 106, 1);background-color:white;color:green;padding:2em;witdh:30%;margin-left:20%">Vous auriez dû réponde : <c:out value="${ solution }"></c:out></p>
                    </div>
                    <div class="card-body">
                        <h1 class="card-title" style="color:white;">MAUVAISE REPONSE</h1>
